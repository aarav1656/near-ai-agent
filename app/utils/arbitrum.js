...
export class Arbitrum {
  ...
  async queryGasPrice() {
    // Arbitrum uses L2 gas pricing, typically querying is the same as Ethereum
  ...
  // This code can be used to actually relay the transaction to the Arbitrum network
